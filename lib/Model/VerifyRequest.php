...
/**
 * VerifyRequest Class Doc Comment
 *
 * @category Class
 * @package  OtpCom\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class VerifyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'VerifyRequest';
     ...
     * Sets otp_id
     *
     * @param string $otp_id The OTP id returned by send/resend.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code The code the recipient entered.
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $code when calling VerifyRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling VerifyRequest., must be bigger than or equal to 1.');
        }
