...
class ResendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets channel
     *
     * @param \OtpCom\Sdk\Model\Channel|null $channel Move this OTP onto a specific channel, e.g. \"sms\" when the recipient has no WhatsApp. The channel must be enabled for your app and the recipient. Omit to advance to the next channel in your routing order.
     *
     * @return self
     */
