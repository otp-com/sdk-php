...
class ResendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets otp_id
     *
     * @param string $otp_id The OTP id to resend.
     *
     * @return self
     */
     ...
     * Sets channel
     *
     * @param \OtpCom\Sdk\Model\Channel|null $channel Move this OTP onto a specific channel, e.g. \"sms\" when the recipient has no WhatsApp. The channel must be enabled for your app and the recipient. Omit to advance to the next channel in your routing order, or to repeat the last one once the order is exhausted.
     *
     * @return self
     */
